...
export class Default1703623500171 implements MigrationInterface {
    name = 'Default1703623500171'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "room_subject" ("subject_id" integer NOT NULL, "room_id" integer NOT NULL, CONSTRAINT "PK_6b3738a7b93c77fd6d9333b638a" PRIMARY KEY ("subject_id", "room_id"))`);
